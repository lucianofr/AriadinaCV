...
export const resume = {
  ...
  skills: {
    project_management: [
      ...
      'Gestão de entregas e apoio à coordenação de programas',
      'Organização de informações gerenciais',
      'Apoio à governança de programas',
    ],
    governance: [
      'Gestão e acompanhamento de contratos',
      'Apoio a processos licitatórios e contratações',
      'Métodos de Aquisição do Banco Interamericano de Desenvolvimento',
      'Gestão orçamentária',
      'Organização de processos e fluxos de trabalho',
      'Normas e procedimentos',
      'BPM (Business Process Management)',
      'Identificação e acompanhamento de riscos',
      'Registro e consolidação de lições aprendidas',
    ],
    monitoring: [
      'Monitoramento de projetos e programas',
      'Consolidação de informações gerenciais',
      'Elaboração de relatórios técnicos e executivos',
      'Acompanhamento de indicadores de desempenho',
      'Apoio ao monitoramento de metas e entregas',
      'Estruturação de apresentações gerenciais',
    ],
    methodologies: [
    ...
    tools: [
      ...
      'Trello',
      'Planner',
      'Ferramentas de gestão e monitoramento de projetos',
      'Ferramentas digitais aplicadas à gestão de projetos e apoio à produtividade',
      'Sistema personalizado para gestão de projetos financiados pelo Banco Interamericano de Desenvolvimento',
      'Desenvolvimento e estruturação de ferramenta para organização, planejamento e monitoramento de documentos gerenciais',
    ],
  },
} as const;
